 ...
 */
declare function splitChunks(content: string, chunkSize?: number, // in tokens
bleed?: number): Promise<string[]>;
...
declare function set(runtime: AgentRuntime, item: KnowledgeItem, chunkSize?: number, // in tokens
bleed?: number): Promise<void>;
