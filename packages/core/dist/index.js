...
var models = {
  ...
  ["aimlapi" /* AIMLAPI */]: {
    ...
    model: {
      ["small" /* SMALL */]: {
        name: settings_default.SMALL_AIMLAPI_MODEL || settings_default.AIMLAPI_MODEL || "gpt-4o-mini",
        stop: [],
        maxInputTokens: 128e3,
        maxOutputTokens: 8192,
        frequency_penalty: 0.4,
      ...
      ["medium" /* MEDIUM */]: {
        name: settings_default.MEDIUM_AIMLAPI_MODEL || settings_default.AIMLAPI_MODEL || "gpt-4o-mini",
        stop: [],
        maxInputTokens: 128e3,
        maxOutputTokens: 8192,
        frequency_penalty: 0.4,
      ...
      ["large" /* LARGE */]: {
        name: settings_default.LARGE_AIMLAPI_MODEL || settings_default.AIMLAPI_MODEL || "gpt-4o-mini",
        stop: [],
        maxInputTokens: 128e3,
        maxOutputTokens: 8192,
        frequency_penalty: 0.4,
  ...
  ["mem0" /* MEM0 */]: {
    endpoint: settings_default.MEM0_API_URL || "https://api.openai.com/v1",
    model: {
      ["small" /* SMALL */]: {
        name: settings_default.SMALL_MEM0_MODEL || "gpt-4o-mini",
        stop: [],
        maxInputTokens: 128e3,
        maxOutputTokens: 8192,
        temperature: 0.6
      ...
      ["medium" /* MEDIUM */]: {
        name: settings_default.MEDIUM_MEM0_MODEL || "gpt-4o",
        stop: [],
        maxInputTokens: 128e3,
        maxOutputTokens: 8192,
        temperature: 0.6
      ...
      ["large" /* LARGE */]: {
        name: settings_default.LARGE_MEM0_MODEL || "gpt-4o",
        stop: [],
        maxInputTokens: 128e3,
        maxOutputTokens: 8192,
        temperature: 0.6
  ...
  ["kluster_ai" /* KLUSTERAI */]: {
    ...
    model: {
      ["small" /* SMALL */]: {
        name: settings_default.SMALL_KLUSTERAI_MODEL || "klusterai/Meta-Llama-3.1-8B-Instruct-Turbo",
        stop: [],
        maxInputTokens: 128e3,
        maxOutputTokens: 8192,
        temperature: 0.6
      ...
      ["medium" /* MEDIUM */]: {
        name: settings_default.MEDIUM_KLUSTERAI_MODEL || "klusterai/Meta-Llama-3.3-70B-Instruct-Turbo",
        stop: [],
        maxInputTokens: 128e3,
        maxOutputTokens: 8192,
        temperature: 0.6
      ...
      ["large" /* LARGE */]: {
        name: settings_default.LARGE_KLUSTERAI_MODEL || "klusterai/Meta-Llama-3.1-405B-Instruct-Turbo",
        stop: [],
        maxInputTokens: 128e3,
        maxOutputTokens: 8192,
        temperature: 0.6
...
var getEmbeddingConfig = () => {
  if (settings_default.USE_CUSTOM_EMBEDDING?.toLowerCase() === "true") {
    if (!settings_default.CUSTOM_EMBEDDING_DIMENSIONS || !settings_default.CUSTOM_EMBEDDING_MODEL || !settings_default.CUSTOM_EMBEDDING_ENDPOINT || !settings_default.CUSTOM_EMBEDDING_API_KEY) {
      logger_default.error("Custom embedding configuration error", {
        dimensions: settings_default.CUSTOM_EMBEDDING_DIMENSIONS,
        model: settings_default.CUSTOM_EMBEDDING_MODEL,
        endpoint: settings_default.CUSTOM_EMBEDDING_ENDPOINT,
        apiKey: settings_default.CUSTOM_EMBEDDING_API_KEY
      });
      throw new Error("Custom embedding enabled but missing required settings");
    }
    return {
      dimensions: Number(settings_default.CUSTOM_EMBEDDING_DIMENSIONS),
      model: settings_default.CUSTOM_EMBEDDING_MODEL,
...
async function embed(runtime, input) {
  ...
  if (config2.provider === EmbeddingProvider.Custom) {
    ...
    case "aimlapi" /* AIMLAPI */:
      {
        switch (modelClass) {
          case "large" /* LARGE */:
            {
              model = runtime.getSetting("LARGE_AIMLAPI_MODEL") || model;
            }
            break;
          case "small" /* SMALL */:
            {
              model = runtime.getSetting("SMALL_AIMLAPI_MODEL") || model;
            }
            break;
        }
      }
...
${context}`;
      ...
      case "mem0" /* MEM0 */: {
        ...
        const baseURL2 = endpoint || getCloudflareGatewayBaseURL(runtime, "openai");
      ...
      case "venice" /* VENICE */: {
        ...
        const bypass = parseBooleanFromText(
          ...
          return runtime.fetch(input, options2);
        } : void 0;
        const veniceConfig = {
          apiKey,
          baseURL: endpoint,
...
var generateImage = async (data, runtime) => {
  ...
  try {
    ...
    } else if (runtime.imageModelProvider === "nearai" /* NEARAI */) {
      let targetSize = `${data.width}x${data.height}`;
      if (targetSize !== "1024x1024" && targetSize !== "1792x1024" && targetSize !== "1024x1792" && targetSize !== "512x512" && targetSize !== "256x256") {
        targetSize = "1024x1024";
      }
      const openai = new OpenAI({
        baseURL: getEndpoint("nearai" /* NEARAI */),
        apiKey
      });
...
async function handleProvider(options2) {
  ...
  switch (provider) {
    ...
    case "aimlapi" /* AIMLAPI */:
      return await handleAIMLAPI(options2);
    case "ollama" /* OLLAMA */:
...
var AgentRuntime = class {
  ...
  async processCharacterKnowledge(items) {
    ...
    for (const a of toAdd) {
      ...
      ps.push(knowledge_default.set(this, {
        id: knowledgeId,
        content: {
          text: item
        }
...
var envSchema = z2.object({
  ...
  AIMLAPI_API_KEY: z2.string().min(1, "AI/ML API key is required"),
